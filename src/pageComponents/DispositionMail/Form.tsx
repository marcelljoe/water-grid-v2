...
import { PropsDispositionForm } from './Disposition.types';
...
const DispositionMail = (props: PropsDispositionForm) => {
  const { isSubmitting, isValid, dirty, values, handleClose, updatedData, employee } = props;
...
export default DispositionMail;
